...
@SpringBootTest
public class RemoveBalanceServiceTest extends BaseOrcTest {


    @Test
    void removeBalanceTestOK(){
        ...
        var response = removeBalanceService.removeBalance(request,headers);
    ...
    void removeBalanceTestKO(){
        ...
        OrcError ex = Assertions.assertThrows(OrcError.class, () ->{
            removeBalanceService.removeBalance(request,headers);
        });
